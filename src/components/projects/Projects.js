...
function Projects() {
  return (
    <div id="projects">
      ...
      />
      <Project
        title="Blood Cell Segmentation"
        desc="An automated blood cell segmentation method was developed using the watershed algorithm to count red blood cells in microscopy images. "
        img={blood}
        git=""
        link=""
      />
      <Project
        ...
        desc="Built a modern React JS portfolio with skill showcases, projects, and a user-friendly Contact Me section. Integrated direct email for seamless communication, enabling easy visitor outreach."
        img={portfolio}
        git="https://github.com/mamtapoojary13/portfolio"
        link="https://mamtapoojary13.github.io/portfolio/"
      />
      <Project
        title="Image Processing(Intern)"
        desc="As an Image Processing Intern, I effectively utilized Python, OpenCV, and Machine Learning to tackle projects, demonstrating skills in computer vision for problem-solving."
        img={intern}
        git=""
        link=""
      />
